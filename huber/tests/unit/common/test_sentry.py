...
from huber.tests.unit import base
from huber import version


CONF = cfg.CONF

DSN = "https://key@glitchtip.example.com/1"
RELEASE = f"huber@{version.version_info.release_string()}"


@mock.patch("huber.common.sentry.sentry_sdk")
